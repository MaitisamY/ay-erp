                    ...
                    <div className="setting-container">
                        ...
                        <div className="box">
                            <div className="inner-box-1">
                                <Card title="Identity" classes="card card-xx-large">
                                                ...
                                                <h5 onClick={handleFileClick}>
                                                    {
                                                        selectedFileName !== '' ? 
                                                        <>
                                                            <MdRefresh className="text-red" size={20} /> <i className="text-red">Change</i> <i>({selectedFileName})</i> 
                                                        </>
                                                        : 
                                                        <>
                                ...
                                <Card title="Organization Details" classes="card card-xx-large">
                                    <Form onSubmit={handleFormSubmit}>
                                        ...
                                        {
                                            orgInfo.name === copyOfOrgInfo.name
                                            && orgInfo.email === copyOfOrgInfo.email
                                            && orgInfo.phone === copyOfOrgInfo.phone
                                            && orgInfo.address === copyOfOrgInfo.address
                                            && orgInfo.website === copyOfOrgInfo.website ? (
                                                <button 
                                                    disabled
